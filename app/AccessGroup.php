...
class AccessGroup extends Model
{
    ...
    {
        return $this->belongsToMany('App\AccessMaster', 'access_group_detail', 'id_access_group', 'id_access_master')->withPivot('priority');
    }

    public function users()
    {
        return $this->hasMany('App\User', 'id_access_group', 'id');
    }
