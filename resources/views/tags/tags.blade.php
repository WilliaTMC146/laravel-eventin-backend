                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            ...
                            <div class="panel-body" id="toro-area">
                                <form id="toro-form" method="POST" action="{{ ($data['actions'] == 'store') ? route('tags.store') : route('tags.update', base64_encode($data['tags']->id)) }}">
...
<script>
    ...
    function TagsViewModel() {
        ...
        self.nama = ko.observable('<?php if (isset($data['tags'])) echo $data['tags']->nama ?>');
        self.keterangan = ko.observable('<?php if (isset($data['tags'])) echo $data['tags']->keterangan ?>');
        self.status = ko.observable(<?= (isset($data['tags'])) ? (($data['tags']->status == 1) ? 'true' : 'false') : 'true' ?>);
    }
