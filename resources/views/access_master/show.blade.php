                                ...
                                <div class="ui card" style="width: 100%;">
                                    ...
                                    <div class="content">
                                        <div class="description">
                                            ...
                                            <p><b>Keterangan : </b> <?php echo $data['access_master']->keterangan ?? '-' ?></p>
                                            <p><b>Created At : </b> {{ date('d-m-Y H:i:s', strtotime($data['access_master']->created_at)) }}</p>
                                            <p><b>Created By : </b> {{ $data['access_master']->user_create->name }}</p>
                                            <p><b>Updated At : </b> {{ date('d-m-Y H:i:s', strtotime($data['access_master']->updated_at)) }}</p>
