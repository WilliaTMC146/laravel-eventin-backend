                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            ...
                            <div class="panel-body" id="toro-area">
                                <form id="toro-form" method="POST" action="{{ ($data['actions'] == 'store') ? route('access_masters.store') : route('access_masters.update', base64_encode($data['access_master']->id)) }}">
...
<script>
    ...
    function SubjectViewModel() {
        ...
        self.nama = ko.observable('<?php if (isset($data['access_master'])) echo $data['access_master']->nama ?>');
        self.keterangan = ko.observable('<?php if (isset($data['access_master'])) echo $data['access_master']->keterangan ?>');
    }
