...
@section('title', 'Role Permission Detail')
@section('content')
<?php
                                    ...
                                    <div class="content">
                                        <div class="description">
                                            ...
                                            <div class="row" style="margin-bottom: 5px;">
                                                ...
                                                <div class="col-sm-10">
                                                    <?php echo $data['role_permission']->keterangan ?>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['role_permission']->status == 1 ? 'Aktif' : 'Tidak Aktif' }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ date('d-m-Y H:i:s', strtotime($data['role_permission']->created_at)) }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['role_permission']->user_create->name }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ date('d-m-Y H:i:s', strtotime($data['role_permission']->updated_at)) }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['role_permission']->user_update->name }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
