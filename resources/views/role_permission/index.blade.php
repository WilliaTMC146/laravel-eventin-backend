                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            ...
                            <div class="panel-body" id="toro-area">
                                @can('access','m_role_permission_create')
                                <a class="btn btn-info" href="{{ route('role_permissions.create') }}">Tambah Role Permission</a>
                                @endcan
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        tabel = $('#toro-data').DataTable({
            ...
            "ajax": {
                "url": "{{ route('role_permissions.datatable') }}",
                "type": "GET",
            },
            "deferRender": true,
            "columnDefs": [{
