                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                else echo 'Ubah'; ?> Organizer
                            </header>
                            <div class="panel-body" id="toro-area">
                                <form id="toro-form" method="POST" action="{{ ($data['actions'] == 'store') ? route('organizers.store') : route('organizers.update', base64_encode($data['organizer']->id)) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="main-img-preview">
                                                <?php if (isset($data['organizer'])) : ?>
                                                    <?php if ($data['organizer']->image != NULL) : ?>
                                                        <img id="preview" name="preview" class="thumbnail img-preview" src="{{asset($data['organizer']->image)}}" title="Preview Foto">
                                                    <?php else : ?>
...
<script>
    ...
    function OrganizerViewModel() {
        ...
        self.nama = ko.observable('<?php if (isset($data['organizer'])) echo $data['organizer']->nama ?>');
        self.keterangan = ko.observable('<?php if (isset($data['organizer'])) echo $data['organizer']->keterangan ?>');
        self.status = ko.observable(<?= (isset($data['organizer'])) ? (($data['organizer']->status == 1) ? 'true' : 'false') : 'true' ?>);
    }
