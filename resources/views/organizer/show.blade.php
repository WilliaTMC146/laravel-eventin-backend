...
@section('title', 'organizer Detail')
@section('content')
<?php
                                    ...
                                    <div class="content">
                                        <div class="description">
                                            ...
                                            <div class="row" style="margin-bottom: 5px;">
                                                ...
                                                <div class="col-sm-10">
                                                    <?php echo $data['organizer']->keterangan ?>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ date('d-m-Y H:i:s', strtotime($data['organizer']->created_at)) }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['organizer']->user_create->name }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ date('d-m-Y H:i:s', strtotime($data['organizer']->updated_at)) }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['organizer']->user_update->name }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
