                                    ...
                                    <div class="content">
                                        <div class="description">
                                            ...
                                            <div class="row" style="margin-bottom: 5px;">
                                                ...
                                                <div class="col-sm-10">
                                                    <?php echo $data['event']->keterangan ?>
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                            ...
                                            <div class="row" style="margin-bottom: 5px;">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ $data['event']->status == 1 ? 'Aktif' : 'Tidak Aktif' }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                            ...
                                            <div class="row" style="margin-bottom: 5px;">
                                                ...
                                                <div class="col-sm-10">
                                                    @if($data['event']->gambar != null)
                                                    <img src="{{URL::asset('uploads/event/' . $data['event']->gambar)}}" width="200" height="200">
                                                    <br>
                                                    <br>
                                                    @endif
                                                </div>
                                            ...
                                            <div class="row" style="margin-bottom: 5px;">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ date('d-m-Y H:i:s', strtotime($data['event']->created_at)) }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
                                            ...
                                            <div class="row" style="margin-bottom: 5px;">
                                                ...
                                                <div class="col-sm-10">
                                                    {{ date('d-m-Y H:i:s', strtotime($data['event']->updated_at)) }}
                                                </div>
                                            </div>
                                            <div class="row" style="margin-bottom: 5px;">
                                                <div class="col-sm-2">
