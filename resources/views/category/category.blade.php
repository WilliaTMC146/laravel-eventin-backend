                    ...
                    <div class="col-md-12">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                else echo 'Ubah'; ?> Category
                            </header>
                            <div class="panel-body" id="toro-area">
                                <form id="toro-form" method="POST" action="{{ ($data['actions'] == 'store') ? route('categories.store') : route('categories.update', base64_encode($data['category']->id)) }}">
...
<script>
    ...
    function CategoryViewModel() {
        ...
        self.nama = ko.observable('<?php if (isset($data['category'])) echo $data['category']->nama ?>');
        self.keterangan = ko.observable('<?php if (isset($data['category'])) echo $data['category']->keterangan ?>');
        self.status = ko.observable(<?= (isset($data['category'])) ? (($data['category']->status == 1) ? 'true' : 'false') : 'true' ?>);
    }
